...
func (c *serviceClient) Sub(ctx context.Context, opts ...grpc.CallOption) (Service_SubClient, error) {
	stream, err := c.cc.NewStream(ctx, &Service_ServiceDesc.Streams[0], "/falco.outputs.service/sub", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *serviceClient) Get(ctx context.Context, in *Request, opts ...grpc.CallOption) (Service_GetClient, error) {
	stream, err := c.cc.NewStream(ctx, &Service_ServiceDesc.Streams[1], "/falco.outputs.service/get", opts...)
	if err != nil {
		return nil, err
	}
